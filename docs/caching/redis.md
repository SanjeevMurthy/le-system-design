...
Use cases: **proximity search** (find nearby drivers, restaurants, stores), location-based features. See [Geospatial Indexing](../patterns/geospatial-indexing.md) for the underlying algorithms.
...
- [Rate Limiting](../resilience/rate-limiting.md) --- rate limiter algorithms implemented with Redis
- [Geospatial Indexing](../patterns/geospatial-indexing.md) --- geohashing algorithms behind Redis GEO commands
- [Consistent Hashing](../scalability/consistent-hashing.md) --- CRC16 mod 16384 in Redis Cluster
