...
- [API Gateway](../architecture/api-gateway.md) -- the infrastructure that routes, authenticates, and rate-limits REST API traffic
- [Authentication and Authorization](../security/authentication-authorization.md) -- OAuth 2.0 and JWT for securing REST APIs
- [Rate Limiting](../resilience/rate-limiting.md) -- protecting REST APIs from abuse (cross-link only)
