...
- [Scaling Overview](../fundamentals/scaling-overview.md) -- the strategic context for autoscaling decisions
- [Back-of-Envelope Estimation](../fundamentals/back-of-envelope-estimation.md) -- estimating the capacity needed for autoscaling configuration
- [Consistent Hashing](./consistent-hashing.md) -- stable data distribution as the cache/database layer scales
- [Monitoring](../observability/monitoring.md) -- the metrics that drive autoscaling decisions
- [Availability and Reliability](../fundamentals/availability-reliability.md) -- autoscaling as an availability mechanism
