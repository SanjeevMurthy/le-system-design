...
- source/extracted/grokking/ch267-cap-theorem.md (CAP theorem definition: consistency, availability, partition tolerance)
...
- source/extracted/grokking/ch63-cache-and-load-balancing.md (cache and load balancing)
- source/extracted/grokking/ch137-replication-and-load-balancer.md (replication and load balancer)
- source/extracted/grokking/ch243-benefits-of-load-balancing.md (benefits of load balancing)
...
- source/extracted/grokking/ch60-data-sharding.md (data sharding)
- source/extracted/grokking/ch108-data-sharding.md (data sharding continued)
...
- source/extracted/alex-xu-vol2/ch10-s3-like-object-storage.md (S3-like object storage design)
...
- source/extracted/grokking/ch81-caching.md (caching strategies)
...
- source/extracted/acing-system-design/ch07-distributed-transactions.md (Event Driven Architecture: asynchronous, non-blocking, loose coupling, scalability)
...
- source/extracted/acing-system-design/ch07-distributed-transactions.md (event sourcing: log as source of truth, publishers/subscribers, audit trail, replay; comparison with CDC)
...
- source/extracted/acing-system-design/ch07-distributed-transactions.md (distributed transactions: event sourcing, CDC, transaction supervisor, saga with choreography and orchestration; comparison table)
...
- source/extracted/grokking/ch113-monitoring.md (monitoring concepts)
...
- source/extracted/acing-system-design/ch19-design-a-news-feed.md (news feed fan-out strategies)
...
- source/extracted/system-design-guide/ch18-designing-a-service-like-netflix.md (Netflix-like video streaming service)
...
- source/extracted/alex-xu-vol2/ch04-google-maps.md (Google Maps with geospatial data)
...
- source/extracted/system-design-guide/ch15-designing-a-service-like-twitter.md (designing a Twitter-like service)
...
- source/extracted/grokking/ch175-difficulties-in-implementing-efficient-web-crawler.md (web crawler difficulties)
...
- source/extracted/acing-system-design/ch19-design-a-news-feed.md (news feed design)
