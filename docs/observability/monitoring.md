...
- [Autoscaling](../scalability/autoscaling.md) -- HPA scales based on metrics; accurate monitoring is a prerequisite for effective autoscaling
- [Availability and Reliability](../fundamentals/availability-reliability.md) -- SLAs, SLOs, and nines of availability are defined and measured through monitoring
- [Time-Series Databases](../storage/time-series-databases.md) -- the storage engines underlying monitoring systems (LSM trees, Gorilla compression, downsampling)
- [Circuit Breaker](../resilience/circuit-breaker.md) -- circuit breaker state transitions are driven by error rate metrics
