...
- [Networking Fundamentals](../fundamentals/networking-fundamentals.md) -- TLS operates at the transport/application layer boundary
- [Database Replication](../storage/database-replication.md) -- replication traffic must be encrypted; WAL shipping should use TLS
- [Object Storage](../storage/object-storage.md) -- server-side encryption and pre-signed URLs for secure blob access
