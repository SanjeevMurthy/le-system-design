...
**Cross-references:** [Fine-Tuning](fine-tuning.md) | [Quantization](../llm-architecture/quantization.md) | [Alignment](../foundations/alignment.md) | [Model Selection](model-selection.md)
...
- **[Quantization](../llm-architecture/quantization.md):** Quantization is complementary to distillation. Distillation reduces model size (architecture), quantization reduces precision. Applied together, they achieve maximum compression (e.g., distilled 7B quantized to INT4 = ~3.5 GB).
- **[Alignment](../foundations/alignment.md):** Distillation can transfer alignment properties (instruction following, safety refusals) from teacher to student. The Zephyr DPO stage explicitly distills preference alignment.
