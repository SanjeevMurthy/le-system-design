...
- **RAG pipeline** ([../rag/rag-pipeline.md](../rag/rag-pipeline.md)): Embedding quality is the single largest determinant of RAG retrieval accuracy. A 5% recall improvement at the embedding stage compounds through reranking and generation.
- **Retrieval and reranking** ([../rag/retrieval-reranking.md](../rag/retrieval-reranking.md)): Bi-encoder embeddings are the first stage; cross-encoder rerankers are the second stage. The embedding model determines the quality ceiling of the candidate set.
- **Embeddings foundations** ([../foundations/embeddings.md](../foundations/embeddings.md)): Conceptual foundations of vector representations, distance metrics, and the evolution from Word2Vec to modern models.
...
- [Embeddings](../foundations/embeddings.md) --- foundational concepts of vector representations, distance metrics, and the evolution from Word2Vec
...
- [Retrieval and Reranking](../rag/retrieval-reranking.md) --- the two-stage pattern where embeddings drive the first stage
- [RAG Pipeline](../rag/rag-pipeline.md) --- end-to-end architecture where embedding quality determines retrieval accuracy
