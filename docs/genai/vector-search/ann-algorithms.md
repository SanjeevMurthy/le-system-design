...
- [Retrieval and Reranking](../rag/retrieval-reranking.md) --- the two-stage pattern where ANN is the first stage
- [Embeddings](../foundations/embeddings.md) --- foundational concepts of vector representations and distance metrics
- [Quantization](../llm-architecture/quantization.md) --- related compression techniques for model weights (analogous concepts)
