...
- **Retrieval and reranking** ([../rag/retrieval-reranking.md](../rag/retrieval-reranking.md)): Hybrid search produces the candidate set for reranking. Better hybrid candidates lead to better reranked results.
- **RAG pipeline** ([../rag/rag-pipeline.md](../rag/rag-pipeline.md)): Hybrid search is a component within the broader RAG orchestration.
...
- [Retrieval and Reranking](../rag/retrieval-reranking.md) --- the two-stage pattern where hybrid search produces the candidate set
...
- [RAG Pipeline](../rag/rag-pipeline.md) --- the end-to-end architecture where hybrid search is a retrieval strategy
- [Embeddings](../foundations/embeddings.md) --- foundational concepts of dense vector representations
