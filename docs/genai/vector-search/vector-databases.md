...
- **RAG pipeline** ([../rag/rag-pipeline.md](../rag/rag-pipeline.md)): The vector database is the primary retrieval backend for RAG. Query latency, filtering capability, and result metadata directly affect RAG quality and speed.
- **Retrieval and reranking** ([../rag/retrieval-reranking.md](../rag/retrieval-reranking.md)): The vector database produces the initial candidate set that the reranker refines.
...
- [RAG Pipeline](../rag/rag-pipeline.md) --- the end-to-end retrieval-augmented generation architecture
- [Retrieval and Reranking](../rag/retrieval-reranking.md) --- the two-stage search pattern that consumes vector database results
- [Embeddings](../foundations/embeddings.md) --- foundational concepts of vector representations
