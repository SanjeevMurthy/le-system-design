...
- **Fine-tuning**: Custom fine-tuning (LoRA, QLoRA) inserts into the post-training pipeline. Poorly designed fine-tuning data can undo safety alignment. See [fine-tuning.md](../model-strategies/fine-tuning.md).
- **Guardrails**: Runtime guardrails are the final defense layer after alignment. They compensate for alignment failures and enforce application-specific policies. See [guardrails.md](../safety/guardrails.md).
- **Red teaming**: Adversarial testing validates alignment robustness. See [red-teaming.md](../safety/red-teaming.md).
...
**System design implication**: No alignment technique eliminates all adversarial attacks. Defense-in-depth requires alignment training + runtime guardrails + monitoring + incident response. See [guardrails.md](../safety/guardrails.md) and [red-teaming.md](../safety/red-teaming.md).
...
- [fine-tuning.md](../model-strategies/fine-tuning.md) -- LoRA, QLoRA, full fine-tuning: the techniques used to implement SFT and DPO in practice. Covers the risk of alignment erasure.
- [guardrails.md](../safety/guardrails.md) -- Runtime safety filters (Guardrails AI, NeMo Guardrails, Llama Guard) that compensate for alignment limitations.
- [red-teaming.md](../safety/red-teaming.md) -- Adversarial testing methodologies for validating alignment robustness.
- [transformers.md](transformers.md) -- The transformer architecture that alignment techniques optimize on top of.
- [prompt-injection.md](../prompt-engineering/prompt-injection.md) -- Adversarial prompt attacks that alignment must defend against.
- [benchmarks.md](../evaluation/benchmarks.md) -- MT-Bench, AlpacaEval, Chatbot Arena, and other alignment quality benchmarks.
- [eval-frameworks.md](../evaluation/eval-frameworks.md) -- Evaluation tools (RAGAS, DeepEval) for measuring alignment-relevant properties like helpfulness and harmlessness.
- [cost-optimization.md](../performance/cost-optimization.md) -- The cost implications of extended thinking and alignment tax.
- [ai-governance.md](../safety/ai-governance.md) -- Regulatory frameworks (EU AI Act, NIST AI RMF) that mandate alignment properties.
