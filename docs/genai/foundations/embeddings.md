...
- [Vector Databases](../vector-search/vector-databases.md) --- storage and retrieval infrastructure for embedding vectors
- [ANN Algorithms](../vector-search/ann-algorithms.md) --- HNSW, IVF, PQ algorithms that power similarity search over embeddings
- [Hybrid Search](../vector-search/hybrid-search.md) --- combining dense embeddings with sparse retrieval (BM25, SPLADE)

**RAG pipeline**:
- [RAG Pipeline](../rag/rag-pipeline.md) --- embeddings are the retrieval backbone of every RAG system
- [Chunking](../rag/chunking.md) --- chunk size must match embedding model context window; embedding quality depends on chunk quality
- [Retrieval and Reranking](../rag/retrieval-reranking.md) --- bi-encoder (embedding) + cross-encoder (reranking) architecture

**Performance and cost**:
- [Cost Optimization](../performance/cost-optimization.md) --- embedding dimension, quantization, and model selection directly affect cost
- [Latency Optimization](../performance/latency-optimization.md) --- embedding latency is part of the end-to-end RAG latency budget
- [Semantic Caching](../performance/semantic-caching.md) --- uses embedding similarity to detect duplicate queries

**Fine-tuning and model selection**:
- [Fine-Tuning](../model-strategies/fine-tuning.md) --- techniques for adapting embedding models to domain-specific data
- [Model Selection](../model-strategies/model-selection.md) --- framework for choosing between embedding model options

**Traditional system design**:
- [Search and Indexing](../../patterns/search-and-indexing.md) --- traditional full-text search complements embedding-based semantic search
- [Recommendation Engines](../../patterns/recommendation-engines.md) --- embeddings power item-item and user-item similarity in recommendation systems
