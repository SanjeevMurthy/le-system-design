...
- [CDN](../caching/cdn.md) --- edge caching of static assets stored in object storage
...
- [Video Streaming](../patterns/video-streaming.md) --- chunked delivery of video from object storage
- [Consistent Hashing](../scalability/consistent-hashing.md) --- data placement in the object store cluster
