...
- [API Security](03-api-security.md) -- input validation, DDoS protection, and injection prevention that complement AuthN/AuthZ
- [Encryption](02-encryption.md) -- TLS secures the transport layer that carries authentication tokens
- [Rate Limiting](../08-resilience/01-rate-limiting.md) -- rate limits are often keyed to authenticated identities
- [API Gateway](../06-architecture/01-api-gateway.md) -- the centralized enforcement point for AuthN/AuthZ policies
- [Microservices](../06-architecture/02-microservices.md) -- service mesh patterns for inter-service authentication
