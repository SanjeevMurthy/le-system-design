...
- [Rate Limiting](../08-resilience/rate-limiting.md) -- rate limits are often keyed to authenticated identities
- [API Gateway](../06-architecture/api-gateway.md) -- the centralized enforcement point for AuthN/AuthZ policies
- [Microservices](../06-architecture/microservices.md) -- service mesh patterns for inter-service authentication
