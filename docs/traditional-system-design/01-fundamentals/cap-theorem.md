...
- **No single point of failure:** No central coordinator (unlike ZooKeeper). Cross-link to [Microservices](../06-architecture/microservices.md) for centralized service discovery.
...
- [Sharding](../02-scalability/sharding.md) -- partitioning data across nodes where consistency models apply
- [Database Replication](../03-storage/database-replication.md) -- the replication strategies that implement consistency guarantees
- [Distributed Transactions](../08-resilience/distributed-transactions.md) -- 2PC and Saga patterns for cross-partition consistency
- [SQL Databases](../03-storage/sql-databases.md) -- ACID compliance as strong consistency
- [Cassandra](../03-storage/cassandra.md) -- tunable consistency in practice
