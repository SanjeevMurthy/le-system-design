...
- [Search and Indexing](05-search-and-indexing.md) -- inverted indexes for text-based retrieval; often a candidate source in Stage 1
- [Message Queues](../05-messaging/01-message-queues.md) -- Kafka streams user interaction events to the feature store and model training pipeline
- [Probabilistic Data Structures](02-probabilistic-data-structures.md) -- Bloom filters for deduplication of already-shown recommendations
- [Caching](../04-caching/01-caching.md) -- pre-computed recommendation lists are cached per user to reduce P99 latency
- [Fan-Out](01-fan-out.md) -- subscription-based candidate generation is a form of fan-out
...
| Collaborative filtering, content-based filtering | Concept Index (patterns/03-recommendation-engines.md entry) |
