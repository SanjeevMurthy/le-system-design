...
- [CDN](../04-caching/cdn.md) -- edge caching of video chunks is the delivery backbone
- [Object Storage](../03-storage/object-storage.md) -- S3/GCS stores raw uploads and processed chunks
- [Message Queues](../05-messaging/message-queues.md) -- asynchronous transcoding job orchestration
- [Real-Time Protocols](../07-api-design/real-time-protocols.md) -- WebRTC for live video; SSE/WS for chat alongside streams
- [Load Balancing](../02-scalability/load-balancing.md) -- distributing transcoding jobs and viewer traffic
