...
- [Database Indexing](../03-storage/04-database-indexing.md) -- B-tree indexes are the foundation for geohash-based queries
- [Redis](../04-caching/02-redis.md) -- geospatial API (GEOADD, GEORADIUS) uses geohashing internally
- [Search and Indexing](05-search-and-indexing.md) -- Elasticsearch supports geospatial queries alongside full-text search
- [Sharding](../02-scalability/04-sharding.md) -- geosharding partitions data by geographic region
- [Probabilistic Data Structures](02-probabilistic-data-structures.md) -- Bloom filters used in Tinder to prevent repeat profile display within geospatial matches
