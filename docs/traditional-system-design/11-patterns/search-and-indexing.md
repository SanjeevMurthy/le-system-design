...
|---------------|-----------|----------------|
| Exact match / Range queries | B-Tree | [Database Indexing](../03-storage/database-indexing.md) |
...
- [Database Indexing](../03-storage/database-indexing.md) -- B-tree and LSM tree indexes for structured queries; complementary to inverted indexes
- [Database Replication](../03-storage/database-replication.md) -- WAL and CDC as the synchronization mechanism to search indexes
...
- [Logging](../10-observability/logging.md) -- ELK stack is the primary consumer of Elasticsearch for observability
