...
- [Message Queues](../05-messaging/message-queues.md) -- Kafka streams user interaction events to the feature store and model training pipeline
...
- [Caching](../04-caching/caching.md) -- pre-computed recommendation lists are cached per user to reduce P99 latency
