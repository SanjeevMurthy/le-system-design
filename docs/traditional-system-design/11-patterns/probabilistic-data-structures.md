...
- [Redis](../04-caching/redis.md) -- native HyperLogLog implementation via PFADD/PFCOUNT
- [Database Indexing](../03-storage/database-indexing.md) -- Bloom filters in LSM tree read paths (Cassandra, RocksDB)
- [Caching](../04-caching/caching.md) -- probabilistic structures reduce cache misses and enable approximate membership tests
