...
|---------------|-----------|----------------|
| Exact match / Range queries | B-Tree | [Database Indexing](../03-storage/04-database-indexing.md) |
| Full-text search | Inverted Index | This file |
| Geospatial (proximity) | Geohash / Quadtree / R-Tree | [Geospatial Indexing](06-geospatial-indexing.md) |
| Vector similarity | HNSW / IVF | [Recommendation Engines](03-recommendation-engines.md) |
| Set membership | Bloom Filter | [Probabilistic Data Structures](02-probabilistic-data-structures.md) |
...
- [Database Indexing](../03-storage/04-database-indexing.md) -- B-tree and LSM tree indexes for structured queries; complementary to inverted indexes
- [Database Replication](../03-storage/05-database-replication.md) -- WAL and CDC as the synchronization mechanism to search indexes
- [Probabilistic Data Structures](02-probabilistic-data-structures.md) -- Bloom filters in Lucene segment files; Count-Min Sketch for hot term detection
- [Geospatial Indexing](06-geospatial-indexing.md) -- Elasticsearch supports both inverted indexes and geospatial indexes
- [Logging](../10-observability/02-logging.md) -- ELK stack is the primary consumer of Elasticsearch for observability
