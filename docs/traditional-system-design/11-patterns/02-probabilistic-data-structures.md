...
- [Search and Indexing](05-search-and-indexing.md) -- Bloom filters optimize read paths in search infrastructure; Count-Min Sketch identifies hot terms
- [Redis](../04-caching/02-redis.md) -- native HyperLogLog implementation via PFADD/PFCOUNT
- [Database Indexing](../03-storage/04-database-indexing.md) -- Bloom filters in LSM tree read paths (Cassandra, RocksDB)
- [Caching](../04-caching/01-caching.md) -- probabilistic structures reduce cache misses and enable approximate membership tests
- [Geospatial Indexing](06-geospatial-indexing.md) -- Bloom filters used in Tinder to prevent repeat profile display
