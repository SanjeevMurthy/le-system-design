...
- [Rate Limiting](./01-rate-limiting.md) -- controls request volume; circuit breaker controls request routing based on failure state
- [Microservices](../06-architecture/02-microservices.md) -- circuit breakers are essential in microservices call chains
- [API Gateway](../06-architecture/01-api-gateway.md) -- gateways often implement circuit breakers for backend services
- [Availability and Reliability](../01-fundamentals/04-availability-reliability.md) -- circuit breakers directly improve system availability
- [Load Balancing](../02-scalability/01-load-balancing.md) -- health checks and outlier detection are related to circuit breaking
