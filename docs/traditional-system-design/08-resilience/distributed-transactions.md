...
- [Event Sourcing](../05-messaging/event-sourcing.md) -- event logs provide the audit trail and replay capability for sagas
- [Event-Driven Architecture](../05-messaging/event-driven-architecture.md) -- choreography and orchestration are EDA patterns
- [Message Queues](../05-messaging/message-queues.md) -- Kafka as the communication backbone for sagas
- [Microservices](../06-architecture/microservices.md) -- distributed transactions are a core challenge in microservices
- [SQL Databases](../03-storage/sql-databases.md) -- ACID transactions within a single database; 2PC for cross-shard
...
- source/extracted/acing-system-design/ch07-distributed-transactions.md (event sourcing, CDC, choreography vs orchestration comparison table, saga, compensating transactions, transaction supervisor)
