...
- [Microservices](../06-architecture/microservices.md) -- circuit breakers are essential in microservices call chains
- [API Gateway](../06-architecture/api-gateway.md) -- gateways often implement circuit breakers for backend services
- [Availability and Reliability](../01-fundamentals/availability-reliability.md) -- circuit breakers directly improve system availability
- [Load Balancing](../02-scalability/load-balancing.md) -- health checks and outlier detection are related to circuit breaking
