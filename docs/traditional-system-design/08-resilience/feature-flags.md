...
- [API Gateway](../06-architecture/api-gateway.md) -- gateways can evaluate flags to route traffic to different backends
...
- [Autoscaling](../02-scalability/autoscaling.md) -- feature flags can disable expensive features as an alternative to scaling
- [Monitoring](../10-observability/monitoring.md) -- flag changes should be correlated with metric changes for root cause analysis
