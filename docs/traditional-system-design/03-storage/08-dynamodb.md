...
- [NoSQL Databases](./02-nosql-databases.md) --- DynamoDB in the NoSQL taxonomy
- [Database Indexing](./04-database-indexing.md) --- B-tree sort keys within partitions
- [Database Replication](./05-database-replication.md) --- DynamoDB Streams as CDC
- [Consistent Hashing](../02-scalability/03-consistent-hashing.md) --- internal partition placement
- [Caching](../04-caching/01-caching.md) --- DAX as a write-through cache pattern
