...
Gossip avoids the single-point-of-failure of centralized coordinators like ZooKeeper while converging quickly even in large clusters. See [CAP Theorem](../01-fundamentals/cap-theorem.md) for how gossip relates to consistency models.
...
- [CAP Theorem](../01-fundamentals/cap-theorem.md) --- consistency models and partition tolerance
- [Consistent Hashing](../02-scalability/consistent-hashing.md) --- data placement in leaderless replication
