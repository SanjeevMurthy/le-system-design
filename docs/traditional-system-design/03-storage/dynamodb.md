...
- [Consistent Hashing](../02-scalability/consistent-hashing.md) --- internal partition placement
- [Caching](../04-caching/caching.md) --- DAX as a write-through cache pattern
