...
- [Consistent Hashing](../02-scalability/consistent-hashing.md) --- token ring and virtual nodes for data placement
- [CAP Theorem](../01-fundamentals/cap-theorem.md) --- tunable consistency as a CAP tradeoff
