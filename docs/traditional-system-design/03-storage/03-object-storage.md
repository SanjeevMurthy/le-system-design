...
- [CDN](../04-caching/03-cdn.md) --- edge caching of static assets stored in object storage
- [SQL Databases](./01-sql-databases.md) --- metadata store for object references
- [Database Replication](./05-database-replication.md) --- replication strategies shared with object storage
- [Video Streaming](../11-patterns/04-video-streaming.md) --- chunked delivery of video from object storage
- [Consistent Hashing](../02-scalability/03-consistent-hashing.md) --- data placement in the object store cluster
...
- source/extracted/alex-xu-vol2/ch10-s3-like-03-object-storage.md (Complete S3 design: data store, metadata, erasure coding, versioning, multipart upload, garbage collection)
