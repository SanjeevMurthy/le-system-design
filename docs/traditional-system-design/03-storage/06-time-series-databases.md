...
- [Database Indexing](./04-database-indexing.md) --- LSM trees and B-trees as storage engine foundations
- [Database Replication](./05-database-replication.md) --- WAL for durability in the TSDB write path
- [Cassandra](./07-cassandra.md) --- shared LSM tree architecture and compaction strategies
- [Monitoring](../10-observability/01-monitoring.md) --- Prometheus/Grafana as the observability stack
