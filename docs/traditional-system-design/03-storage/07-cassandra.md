...
- [NoSQL Databases](./02-nosql-databases.md) --- Cassandra as a wide-column store in the NoSQL taxonomy
- [Database Indexing](./04-database-indexing.md) --- LSM trees, SSTables, and Bloom filters
- [Database Replication](./05-database-replication.md) --- leaderless replication and quorum consistency
- [Consistent Hashing](../02-scalability/03-consistent-hashing.md) --- token ring and virtual nodes for data placement
- [CAP Theorem](../01-fundamentals/05-cap-theorem.md) --- tunable consistency as a CAP tradeoff
