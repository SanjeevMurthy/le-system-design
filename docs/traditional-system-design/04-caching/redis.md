...
For caching strategies and patterns (cache-aside, write-through, etc.), see [Caching Strategies](./caching.md). This file covers Redis-specific internals, data structures, and operational patterns.
...
Use cases: **proximity search** (find nearby drivers, restaurants, stores), location-based features. See [Geospatial Indexing](../11-patterns/geospatial-indexing.md) for the underlying algorithms.
...
- [Caching Strategies](./caching.md) --- cache-aside, write-through, and other patterns (not Redis-specific)
- [CDN](./cdn.md) --- edge caching layer complementing Redis
- [Rate Limiting](../08-resilience/rate-limiting.md) --- rate limiter algorithms implemented with Redis
- [Geospatial Indexing](../11-patterns/geospatial-indexing.md) --- geohashing algorithms behind Redis GEO commands
- [Consistent Hashing](../02-scalability/consistent-hashing.md) --- CRC16 mod 16384 in Redis Cluster
