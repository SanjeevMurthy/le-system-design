...
- [Database Replication](../03-storage/database-replication.md) --- read replicas as an alternative to caching for read scaling
- [Rate Limiting](../08-resilience/rate-limiting.md) --- rate limiters often implemented on top of cache infrastructure
- [Consistent Hashing](../02-scalability/consistent-hashing.md) --- distributing cache keys across a cluster
