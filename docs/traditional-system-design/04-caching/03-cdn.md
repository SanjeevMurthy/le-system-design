...
- [Caching Strategies](./01-caching.md) --- CDN as one layer in the multi-tier caching architecture
- [Object Storage](../03-storage/03-object-storage.md) --- S3 as the origin for CDN-served assets
- [Video Streaming](../11-patterns/04-video-streaming.md) --- adaptive bitrate streaming via CDN
- [Load Balancing](../02-scalability/01-load-balancing.md) --- CDN as a geographic load distribution layer
- [Networking Fundamentals](../01-fundamentals/06-networking-fundamentals.md) --- DNS, TCP, and the network stack underlying CDN
