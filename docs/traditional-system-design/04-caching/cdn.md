...
- [Object Storage](../03-storage/object-storage.md) --- S3 as the origin for CDN-served assets
- [Video Streaming](../11-patterns/video-streaming.md) --- adaptive bitrate streaming via CDN
- [Load Balancing](../02-scalability/load-balancing.md) --- CDN as a geographic load distribution layer
- [Networking Fundamentals](../01-fundamentals/networking-fundamentals.md) --- DNS, TCP, and the network stack underlying CDN
