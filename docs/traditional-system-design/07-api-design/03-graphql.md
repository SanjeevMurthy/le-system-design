...
- [REST API](01-rest-api.md) -- the traditional alternative; better for cacheable, public APIs
- [gRPC](02-grpc.md) -- binary protocol preferred for internal microservice communication
- [Real-Time Protocols](04-real-time-protocols.md) -- WebSockets (used by GraphQL subscriptions), SSE alternatives
- [Caching](../04-caching/01-caching.md) -- application-level caching strategies needed since HTTP caching is limited
- [API Gateway](../06-architecture/01-api-gateway.md) -- often hosts the GraphQL federation layer
...
| Federation and gateway composition | Concept Index (api-design/03-graphql.md entry) |
