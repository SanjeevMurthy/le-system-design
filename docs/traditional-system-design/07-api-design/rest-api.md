...
- [gRPC](grpc.md) -- binary alternative for internal microservice communication; see comparison in Section 6
- [GraphQL](graphql.md) -- query-based alternative that solves over/under-fetching
- [API Gateway](../06-architecture/api-gateway.md) -- the infrastructure that routes, authenticates, and rate-limits REST API traffic
- [Authentication and Authorization](../09-security/authentication-authorization.md) -- OAuth 2.0 and JWT for securing REST APIs
- [Rate Limiting](../08-resilience/rate-limiting.md) -- protecting REST APIs from abuse (cross-link only)
