...
- [Caching](../04-caching/caching.md) -- application-level caching strategies needed since HTTP caching is limited
- [API Gateway](../06-architecture/api-gateway.md) -- often hosts the GraphQL federation layer
