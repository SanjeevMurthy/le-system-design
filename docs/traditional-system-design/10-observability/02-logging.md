...
- [Monitoring](01-monitoring.md) -- metrics provide the quantitative "what"; logs provide the qualitative "why"
- [Search and Indexing](../11-patterns/05-search-and-indexing.md) -- Elasticsearch's inverted index is the same technology powering full-text log search
- [Event-Driven Architecture](../05-messaging/02-event-driven-architecture.md) -- event logs and application logs often share infrastructure (Kafka as log buffer)
- [Microservices](../06-architecture/02-microservices.md) -- distributed tracing is essential for debugging microservices architectures
- [Availability and Reliability](../01-fundamentals/04-availability-reliability.md) -- MTTD and MTTR are directly impacted by logging and tracing quality
