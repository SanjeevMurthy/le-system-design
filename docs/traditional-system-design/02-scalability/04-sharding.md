...
- **Cross-Shard Transaction:** A transaction that spans multiple shards. Requires distributed coordination (2PC or Saga). Cross-link to [Distributed Transactions](../08-resilience/03-distributed-transactions.md).
...
| Simple to implement | Mitigated by using [Consistent Hashing](./03-consistent-hashing.md) |
...
3. **Hybrid Fan-out:** For read-heavy celebrity data (e.g., timelines), use fan-out on read for celebrities and fan-out on write for normal users. Cross-link to [Fan-out](../11-patterns/01-fan-out.md).
...
**Two-Phase Commit (2PC):** Cross-link to [Distributed Transactions](../08-resilience/03-distributed-transactions.md).
...
**Saga Pattern:** Cross-link to [Distributed Transactions](../08-resilience/03-distributed-transactions.md).
...
- Use [Consistent Hashing](./03-consistent-hashing.md) to ensure that adding/removing a node only affects K/N keys.
...
- [Consistent Hashing](./03-consistent-hashing.md) -- the distribution mechanism that makes sharding scalable
- [Load Balancing](./01-load-balancing.md) -- distributing traffic across application servers above the sharded database
- [CAP Theorem](../01-fundamentals/05-cap-theorem.md) -- consistency trade-offs in sharded, distributed systems
- [Distributed Transactions](../08-resilience/03-distributed-transactions.md) -- 2PC and Saga patterns for cross-shard operations
- [SQL Databases](../03-storage/01-sql-databases.md) -- the single-node databases that sharding extends
- [Cassandra](../03-storage/07-cassandra.md) -- a database with built-in sharding via consistent hashing
...
- source/extracted/grokking/ch60-data-04-sharding.md -- Data sharding strategies
