...
- [Load Balancing](./load-balancing.md) -- distributing traffic across the scaled pool
- [Scaling Overview](../01-fundamentals/scaling-overview.md) -- the strategic context for autoscaling decisions
- [Back-of-Envelope Estimation](../01-fundamentals/back-of-envelope-estimation.md) -- estimating the capacity needed for autoscaling configuration
- [Consistent Hashing](./consistent-hashing.md) -- stable data distribution as the cache/database layer scales
- [Monitoring](../10-observability/monitoring.md) -- the metrics that drive autoscaling decisions
- [Availability and Reliability](../01-fundamentals/availability-reliability.md) -- autoscaling as an availability mechanism
