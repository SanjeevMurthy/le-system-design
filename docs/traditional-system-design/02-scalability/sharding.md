...
- **Cross-Shard Transaction:** A transaction that spans multiple shards. Requires distributed coordination (2PC or Saga). Cross-link to [Distributed Transactions](../08-resilience/distributed-transactions.md).
...
3. **Hybrid Fan-out:** For read-heavy celebrity data (e.g., timelines), use fan-out on read for celebrities and fan-out on write for normal users. Cross-link to [Fan-out](../11-patterns/fan-out.md).
...
**Two-Phase Commit (2PC):** Cross-link to [Distributed Transactions](../08-resilience/distributed-transactions.md).
...
**Saga Pattern:** Cross-link to [Distributed Transactions](../08-resilience/distributed-transactions.md).
...
- [CAP Theorem](../01-fundamentals/cap-theorem.md) -- consistency trade-offs in sharded, distributed systems
- [Distributed Transactions](../08-resilience/distributed-transactions.md) -- 2PC and Saga patterns for cross-shard operations
- [SQL Databases](../03-storage/sql-databases.md) -- the single-node databases that sharding extends
- [Cassandra](../03-storage/cassandra.md) -- a database with built-in sharding via consistent hashing
