...
- [Database Replication](../03-storage/database-replication.md) -- CDC as a mechanism for CQRS projection updates
- [Caching](../04-caching/caching.md) -- read models are conceptually similar to cache layers
