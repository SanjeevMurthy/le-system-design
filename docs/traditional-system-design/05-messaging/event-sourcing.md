...
- [Distributed Transactions](../08-resilience/distributed-transactions.md) -- saga pattern uses event logs for coordination
- [Database Replication](../03-storage/database-replication.md) -- CDC as a related but distinct pattern
