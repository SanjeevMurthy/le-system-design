...
- [Event-Driven Architecture](../messaging/event-driven-architecture.md) -- Lambda is inherently event-driven; EventBridge is the serverless event bus
...
- [DynamoDB](../storage/dynamodb.md) -- the canonical serverless database; Streams enable CDC triggers
- [Message Queues](../messaging/message-queues.md) -- SQS as a Lambda trigger for asynchronous processing
- [CQRS](../messaging/cqrs.md) -- serverless naturally supports CQRS with separate read/write Lambda functions
- [Circuit Breaker](../resilience/circuit-breaker.md) -- Step Functions implement circuit breaker patterns for external API calls
- [Distributed Transactions](../resilience/distributed-transactions.md) -- Step Functions implement the saga pattern for multi-step workflows
