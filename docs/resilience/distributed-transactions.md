...
- [Event Sourcing](../messaging/event-sourcing.md) -- event logs provide the audit trail and replay capability for sagas
- [Event-Driven Architecture](../messaging/event-driven-architecture.md) -- choreography and orchestration are EDA patterns
- [Message Queues](../messaging/message-queues.md) -- Kafka as the communication backbone for sagas
- [Microservices](../architecture/microservices.md) -- distributed transactions are a core challenge in microservices
- [SQL Databases](../storage/sql-databases.md) -- ACID transactions within a single database; 2PC for cross-shard
