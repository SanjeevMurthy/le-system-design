...
- **[Training Infrastructure](../03-model-strategies/training-infrastructure.md):** GPU cluster design for training workloads, which have different requirements (higher compute utilization, gradient communication) than inference
- **[Kubernetes for GenAI](../13-case-studies/kubernetes-genai.md):** Orchestrating GPU resources via Kubernetes GPU Operator, device plugins, and scheduling
