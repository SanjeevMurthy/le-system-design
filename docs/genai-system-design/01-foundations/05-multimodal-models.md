...
- **RAG pipelines**: Multimodal embeddings (CLIP, SigLIP) enable retrieval over images, diagrams, and charts alongside text. See [06-multimodal-rag.md](../04-rag/06-multimodal-rag.md).
...
- **Voice AI**: The STT-to-LLM-to-TTS pipeline is increasingly replaced by natively multimodal models like GPT-4o that process audio end-to-end. See [04-voice-ai.md](../13-case-studies/04-voice-ai.md).
- **Document ingestion**: Vision-language models replace traditional OCR+heuristics for layout-aware document understanding. See [02-document-ingestion.md](../04-rag/02-document-ingestion.md).
- **Guardrails & safety**: Multimodal content requires visual safety classifiers alongside text-based guardrails. See [01-guardrails.md](../10-safety/01-guardrails.md).
...
- Multimodal RAG retrieval: Embed both document images and text queries in CLIP space. See [06-multimodal-rag.md](../04-rag/06-multimodal-rag.md).
...
- [01-transformers.md](01-transformers.md) -- Foundational transformer architecture: attention, positional encoding, MHA/GQA that underpin all multimodal models.
- [02-llm-landscape.md](02-llm-landscape.md) -- The LLM models that serve as backbones for VLMs and audio language models.
- [06-multimodal-rag.md](../04-rag/06-multimodal-rag.md) -- Retrieval-augmented generation over images, tables, and documents using multimodal embeddings.
- [04-voice-ai.md](../13-case-studies/04-voice-ai.md) -- End-to-end voice AI pipeline: STT -> LLM -> TTS, real-time conversational architecture.
- [02-document-ingestion.md](../04-rag/02-document-ingestion.md) -- Document parsing, OCR, table extraction pipelines that multimodal models are replacing.
- [04-embeddings.md](04-embeddings.md) -- Text embedding models and techniques; CLIP/SigLIP extend these to multimodal spaces.
- [01-model-serving.md](../02-llm-architecture/01-model-serving.md) -- vLLM, TensorRT-LLM, SGLang serving infrastructure that supports multimodal models.
- [04-kv-cache.md](../02-llm-architecture/04-kv-cache.md) -- KV cache management: multimodal prefill produces large caches from visual tokens.
- [03-cost-optimization.md](../11-performance/03-cost-optimization.md) -- Token economics and cost management strategies for multimodal workloads.
- [01-guardrails.md](../10-safety/01-guardrails.md) -- Safety filtering for multimodal content (visual content moderation).
