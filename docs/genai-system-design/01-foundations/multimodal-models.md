...
- **RAG pipelines**: Multimodal embeddings (CLIP, SigLIP) enable retrieval over images, diagrams, and charts alongside text. See [multimodal-rag.md](../04-rag/multimodal-rag.md).
...
- **Voice AI**: The STT-to-LLM-to-TTS pipeline is increasingly replaced by natively multimodal models like GPT-4o that process audio end-to-end. See [voice-ai.md](../13-case-studies/voice-ai.md).
- **Document ingestion**: Vision-language models replace traditional OCR+heuristics for layout-aware document understanding. See [document-ingestion.md](../04-rag/document-ingestion.md).
- **Guardrails & safety**: Multimodal content requires visual safety classifiers alongside text-based guardrails. See [guardrails.md](../10-safety/guardrails.md).
...
- Multimodal RAG retrieval: Embed both document images and text queries in CLIP space. See [multimodal-rag.md](../04-rag/multimodal-rag.md).
...
- [multimodal-rag.md](../04-rag/multimodal-rag.md) -- Retrieval-augmented generation over images, tables, and documents using multimodal embeddings.
- [voice-ai.md](../13-case-studies/voice-ai.md) -- End-to-end voice AI pipeline: STT -> LLM -> TTS, real-time conversational architecture.
- [document-ingestion.md](../04-rag/document-ingestion.md) -- Document parsing, OCR, table extraction pipelines that multimodal models are replacing.
- [embeddings.md](embeddings.md) -- Text embedding models and techniques; CLIP/SigLIP extend these to multimodal spaces.
- [model-serving.md](../02-llm-architecture/model-serving.md) -- vLLM, TensorRT-LLM, SGLang serving infrastructure that supports multimodal models.
- [kv-cache.md](../02-llm-architecture/kv-cache.md) -- KV cache management: multimodal prefill produces large caches from visual tokens.
- [cost-optimization.md](../11-performance/cost-optimization.md) -- Token economics and cost management strategies for multimodal workloads.
- [guardrails.md](../10-safety/guardrails.md) -- Safety filtering for multimodal content (visual content moderation).
