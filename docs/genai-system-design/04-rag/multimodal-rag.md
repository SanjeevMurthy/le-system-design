...
- **Multimodal models** ([multimodal-models.md](../01-foundations/multimodal-models.md)): The generation model must be vision-language capable (GPT-4o, Gemini 2.0, Claude 3.5 Sonnet, Llama 3.2 Vision) to consume image and table context.
...
- **Embedding models** ([embeddings.md](../01-foundations/embeddings.md)): Text embedding models handle the textual modality; vision embedding models (CLIP, SigLIP) handle images.
- **Vector databases** ([vector-databases.md](../05-vector-search/vector-databases.md)): Must support multiple indices (one per modality) or multi-vector storage.
...
- [Multimodal Models](../01-foundations/multimodal-models.md) --- Architecture and capabilities of vision-language models used for multimodal generation and understanding.
...
- [Embedding Models](../01-foundations/embeddings.md) --- Text embedding models and their role alongside vision embeddings.
- [Vector Databases](../05-vector-search/vector-databases.md) --- Storage and retrieval infrastructure for multimodal embeddings, including multi-vector support.
