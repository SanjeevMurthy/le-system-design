...
- [Rate Limiting](../resilience/rate-limiting.md) -- backpressure and throttling at the producer level
- [Redis](../caching/redis.md) -- Redis Streams as a lightweight alternative for simple queuing
