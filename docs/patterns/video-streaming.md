...
- [CDN](../caching/cdn.md) -- edge caching of video chunks is the delivery backbone
- [Object Storage](../storage/object-storage.md) -- S3/GCS stores raw uploads and processed chunks
- [Message Queues](../messaging/message-queues.md) -- asynchronous transcoding job orchestration
- [Real-Time Protocols](../api-design/real-time-protocols.md) -- WebRTC for live video; SSE/WS for chat alongside streams
- [Load Balancing](../scalability/load-balancing.md) -- distributing transcoding jobs and viewer traffic
