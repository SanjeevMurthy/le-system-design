...
> Source: Designing Data-Intensive Applications (Martin Kleppmann), Chapter 8, Pages 221-242

## Key Concepts

- i. Partitioning, as discussed in this chapter, is a way of intentionally breaking a large database down into
smaller ones. It has nothing to do with network partitions (netsplits), a type of fault in 
...
For queries that operate on a sin
